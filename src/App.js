				...
				<div className="third-section-inner">
					...
					>
						...
						<div style={{ width: "569px" }}>
							...
							>
								You have the possibility with Bioquizz to train on any category
								you want. Among the categories there are:
								<br />
								-Mediterranean
								<br />
								-Atlantic
				...
				<div className="third-section-inner">
					...
					>
						<div style={{ width: "569px" }}>
							...
							>
								Compete against the other Bioquiz player and gain places in the
								ranking. This space allows you to assess your level of play and
								why not give you potential motivation to reach the podium!
							</p>
						</div>
						<img src={phone2} />
					</div>
					...
					<Accordion>
						...
						<AccordionDetails>
							<Typography>
								...
								in quam vehicula nisi fringilla ultrices. Integer efficitur sed
								ante rutrum fermentum. Fusce convallis aliquet neque, eu
								tincidunt enim venenatis sit amet.
							</Typography>
						</AccordionDetails>
					</Accordion>
					<Accordion>
						<AccordionSummary
							...
							id="panel2d-header"
						>
							<Typography>Is the Bioquie app intended for everyone?</Typography>
						</AccordionSummary>
						<AccordionDetails>
							<Typography>
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris
			...
			<section className="fifth-section">
				<div className="fifth-section-inner">
					<div style={{ padding: "60px 80px", position: "relative" }}>
						...
						<img
							src={appStore}
							style={{ width: "fit-content", paddingTop: "60px" }}
						/>
